    ...
    <section className="max-w-5xl mx-auto px-6 py-10">
      ...
      <div className="flex flex-col md:flex-row mb-10 gap-6">
        <div className="flex items-center gap-4">
          <img className="w-12 h-12 rounded-full" src="what-they-say.png" alt="" />
          <div>
          ...
          <div className="flex items-center gap-4 w-full max-w-3xl mx-auto min-h-20">
              ...
              <div className="flex gap-3 shrink-0">
                  <button onClick={showPrevious} className="w-8 h-8 bg-white rounded-full">
                  <i className="fas fa-arrow-left" id='i'></i>
                  </button>
                  <button onClick={showNext} className="w-8 h-8 bg-white rounded-full">
                  <i className="fas fa-arrow-right" id='i'></i>
                  </button>
              </div>
          </div>
      </div>
